...
public class EditIntroViewPagerAdapter extends PagerAdapter {

    Context mContext;
    List<ScreenItem> mListScreen;

    public EditIntroViewPagerAdapter(Context mContext, List<ScreenItem> mListScreen) {
        ...
        overlay_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              /*  Intent selectionActivity = new Intent(mContext.getApplicationContext(), ModulesPage.class);
                ...
                Intent modulesPage = new Intent(mContext.getApplicationContext(), EditModulesPage.class);
